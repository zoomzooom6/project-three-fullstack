...
import { addCart, updateCartQuantity, updateProducts } from '../app/actions/actions'
...
function Home() {
  ...
  const addToCart = () => {
    ...
    if (itemInCart) {
      dispatch(updateCartQuantity(_id, itemInCart.quantity + 1));
    } else {
