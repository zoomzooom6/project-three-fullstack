...
<div id="navbarBasicExample" class="navbar-menu">
    ...
    <div className="tabs is-toggle is-fullwidth" id="tabs">
        <ul>
            ...
            <li data-tab="2">
                <a>
                <span className="icon is-small"><i className="fas fa-file-invoice-dollar"></i></span>
            ...
            <li data-tab="4">
                <a>
                <span className="icon is-small"><i className="fas fa-comment-alt"></i></span>
...
<h1 className="title is-1" id="help-desk">Customer Help Desk</h1>

<form>
<div className="field">
<label className="label">Your Email</label>
<div className="control has-icons-left has-icons-right">
<input className="input is-danger" type="email" placeholder="Please enter your email"/>
...
<div className="control has-icons-left has-icons-right">
<input className="input is-danger" type="email" placeholder="Please enter the vendor's email"/>
<span className="icon is-small is-left">
<i className="fas fa-envelope"></i>
</span>
<span className="icon is-small is-right">
...
<input className="input" type="text" placeholder="Please enter the email's subject"/>
</div>
</div>
...
<div className="control">
<textarea className="textarea" placeholder="Please enter your concern(s)"></textarea>
</div>
</div>
